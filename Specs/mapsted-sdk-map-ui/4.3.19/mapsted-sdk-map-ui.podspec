Pod::Spec.new do |s|  
    ...
    s.platform          = :ios
    s.source            = { :git => "https://github.com/Mapsted/mapsted-sdk-map-ui.git", :tag => '4.3.19' }
    s.source_files  = "MapstedMapUi.framework/Headers/*.{h,m}"
    s.ios.deployment_target = '12.3'
    s.ios.vendored_frameworks = "MapstedMapUi.framework"
    s.libraries = "z", "c++"
    s.dependency 'mapsted-sdk-map', '4.3.19'
    s.dependency 'mapsted-sdk-loc-marketing', '4.3.19'
end  