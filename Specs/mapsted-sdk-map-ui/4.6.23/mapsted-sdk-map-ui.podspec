Pod::Spec.new do |s|  
    ...
    s.platform          = :ios
    s.source            = { :git => "https://github.com/Mapsted/mapsted-sdk-map-ui.git", :tag => '4.6.23' }
    ...
    s.libraries = "z", "c++"
    s.dependency 'mapsted-sdk-map', '4.6.23'
    s.dependency 'mapsted-sdk-loc-marketing', '4.6.23'
    s.dependency 'mapsted-sdk-alerts', '4.6.23'
end  