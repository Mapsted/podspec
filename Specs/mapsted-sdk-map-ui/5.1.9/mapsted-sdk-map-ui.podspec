Pod::Spec.new do |s|  
    ...
    s.platform          = :ios
    s.source            = { :git => "https://github.com/Mapsted/mapsted-sdk-map-ui.git", :tag => '5.1.9' }
    ...
    s.libraries = "z", "c++"
    s.dependency 'mapsted-sdk-map', '5.1.9'
    s.dependency 'mapsted-sdk-loc-marketing', '5.1.9'
    s.dependency 'mapsted-sdk-alerts', '5.1.9'
end  